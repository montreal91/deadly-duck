...
def PlayoffRecordComparator( record ):
    if record.last_playoff_series.top_seed_pk == record.club_pk:
        return record.last_playoff_series.GetTopSeedMatchesWon( DdLeagueConfig.SETS_TO_WIN )
    elif record.last_playoff_series.low_seed_pk == record.club_pk:
        return record.last_playoff_series.GetLowSeedMatchesWon( DdLeagueConfig.SETS_TO_WIN )
