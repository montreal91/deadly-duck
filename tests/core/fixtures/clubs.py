...
INITIAL_CLUBS = (
    ...
    ExpectedInitialClub("farm_club_0", "Farm Club 0", 0, 0, 1, 0),
    ExpectedInitialClub("farm_club_1", "Farm Club 1", 0, 0, 1, 0),
    ExpectedInitialClub("farm_club_2", "Farm Club 2", 0, 0, 1, 0),
    ExpectedInitialClub("farm_club_3", "Farm Club 3", 0, 0, 1, 0),
    ExpectedInitialClub("farm_club_4", "Farm Club 4", 0, 0, 1, 0),
    ExpectedInitialClub("farm_club_5", "Farm Club 5", 0, 0, 1, 0),
    ExpectedInitialClub("farm_club_6", "Farm Club 6", 0, 0, 1, 0),
    ExpectedInitialClub("farm_club_7", "Farm Club 7", 0, 0, 1, 0),
    ExpectedInitialClub("farm_club_8", "Farm Club 8", 0, 0, 1, 0),
    ExpectedInitialClub("farm_club_9", "Farm Club 9", 0, 0, 1, 0),
    ExpectedInitialClub("farm_club_10", "Farm Club 10", 0, 0, 1, 0),
    ExpectedInitialClub("farm_club_11", "Farm Club 11", 0, 0, 1, 0),
    ExpectedInitialClub("farm_club_12", "Farm Club 12", 0, 0, 1, 0),
    ExpectedInitialClub("farm_club_13", "Farm Club 13", 0, 0, 1, 0),
    ExpectedInitialClub("farm_club_14", "Farm Club 14", 0, 0, 1, 0),
    ExpectedInitialClub("farm_club_15", "Farm Club 15", 0, 0, 1, 0),
    ExpectedInitialClub("farm_club_16", "Farm Club 16", 0, 0, 1, 0),
    ExpectedInitialClub("farm_club_17", "Farm Club 17", 0, 0, 1, 0),
)
