...
Revision ID: 1ef0df3166a
Revises: 
Create Date: 2019-02-03 02:27:58.588955
...
def upgrade():
    ...
    sa.Column('social_pk', sa.String(length=64), nullable=False),
    ...
    sa.PrimaryKeyConstraint('pk'),
    sa.UniqueConstraint('social_pk')
    )
    op.create_index(op.f('ix_users_email'), 'users', ['email'], unique=False)
    op.create_index(op.f('ix_users_username'), 'users', ['username'], unique=False)
    op.create_table('careers',
    sa.Column('pk', sa.Integer(), nullable=False),
    sa.Column('title_c', sa.String(length=100), nullable=True),
    sa.Column('managed_club_pk', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['managed_club_pk'], ['clubs.pk'], ),
    ...
    sa.Column('is_active', sa.Boolean(), nullable=True),
    sa.Column('career_pk', sa.Integer(), nullable=True),
    sa.Column('club_pk', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['career_pk'], ['careers.pk'], ),
    sa.ForeignKeyConstraint(['club_pk'], ['clubs.pk'], ),
    sa.PrimaryKeyConstraint('pk')
    )
    ...
    sa.Column('career_pk', sa.Integer(), nullable=False),
    ...
    sa.Column('max_matches_n', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['career_pk'], ['careers.pk'], ),
    sa.ForeignKeyConstraint(['low_seed_pk'], ['clubs.pk'], ),
    sa.ForeignKeyConstraint(['top_seed_pk'], ['clubs.pk'], ),
    sa.PrimaryKeyConstraint('pk')
    )
    op.create_index(op.f('ix_playoff_series_career_pk'), 'playoff_series', ['career_pk'], unique=False)
    ...
    sa.ForeignKeyConstraint(['away_player_pk'], ['players.pk'], ),
    sa.ForeignKeyConstraint(['away_team_pk'], ['clubs.pk'], ),
    sa.ForeignKeyConstraint(['career_pk'], ['careers.pk'], ),
    sa.ForeignKeyConstraint(['home_player_pk'], ['players.pk'], ),
    sa.ForeignKeyConstraint(['home_team_pk'], ['clubs.pk'], ),
    sa.ForeignKeyConstraint(['playoff_series_pk'], ['playoff_series.pk'], ),
    sa.PrimaryKeyConstraint('pk')
    )
    op.create_index(op.f('ix_matches_career_pk'), 'matches', ['career_pk'], unique=False)
    ### end Alembic commands ###


def downgrade():
    ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_matches_career_pk'), table_name='matches')
    op.drop_table('matches')
    op.drop_index(op.f('ix_playoff_series_career_pk'), table_name='playoff_series')
